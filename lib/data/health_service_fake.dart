...
class FakeHealthService implements HealthRepository {
  ...
  Future<List<MetricSample>> fetchSeries(HealthMetric metric, {int days = 7}) async {
    ...
    final (base, spread) = switch (metric) {
      ...
      HealthMetric.flightsClimbed => (12.0, 8.0),
      HealthMetric.basalEnergy => (1600.0, 200.0),
      HealthMetric.totalCalories => (2400.0, 400.0),
      HealthMetric.exerciseTime => (35.0, 25.0),
      HealthMetric.standTime => (600.0, 120.0),
      HealthMetric.moveMinutes => (45.0, 20.0),
      HealthMetric.mindfulness => (10.0, 8.0),
      HealthMetric.distanceCycling => (6.0, 5.0),
      HealthMetric.distanceSwimming => (0.8, 0.5),
      HealthMetric.walkingHeartRate => (95.0, 12.0),
      HealthMetric.leanBodyMass => (58.0, 2.0),
      HealthMetric.bmi => (23.5, 1.0),
      HealthMetric.waist => (82.0, 3.0),
      HealthMetric.bodyWater => (42.0, 2.0),
      HealthMetric.walkingSpeed => (5.2, 1.0),
      HealthMetric.carbs => (230.0, 60.0),
      HealthMetric.protein => (95.0, 25.0),
      HealthMetric.fat => (70.0, 20.0),
      HealthMetric.skinTemperature => (33.5, 0.6),
    };
