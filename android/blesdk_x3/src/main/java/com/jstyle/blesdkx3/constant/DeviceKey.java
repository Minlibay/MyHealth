...
public class DeviceKey {
    public static final String OsaSwitch = "OsaSwitch";
    public static final String KOsaRick = "osaRick";
    public static final String ArrayListData = "ArrayListData";
    public static final String Data_length = "Data_length";
    public static final String Sleep_level = "Sleep_level";
    public static final String Activity_level = "Activity_level";
    public static final String KEovRiskCount = "eovRiskCount";
    public static final String KEovLen = "eovLen";
    public static final String KEovDataList = "eovDataList";

    public static final String  Fina_temperature_value = "Final_temperature_value";
    public static final String  Temperature_value_of_channel_1 = "Temperature_value_of_channel_1";
    public static final String  Temperature_value_of_channel_2 = "Temperature_value_of_channel_2";
    public static final String  Temperature_value_of_channel_3 = "Temperature_value_of_channel_3";

    public static final String Left_and_right_hand_signs = "Left_and_right_hand_signs";
    public static final String Automatically_detect_motion = "Automatically_detect_motion";
    public static final String EOV = "EOV";
    public static final String Sp02 = "Sp02";
