...
public class BleConst {
   ...
   public static final String deleteGetTemperature_historyDataWithMode3ntc="121";
   public static final String Temperature_history3ntc="122";
   public static final String CMD_Set_the_basic_parameters_of_the_ring="123";
   public static final String CMD_Get_the_basic_parameters_of_the_ring="124";

   public static final String ReadSpo2="125";
   public static final String DeleteSpo2="126";
   public static final String Realtime_ppg="127";
   public static final String openPPG="128";
   public static final String ClosePPG="129";


   public static final String readPPI="130";
   public static final String DeletePPI="131";
   public static final String CMD_Get_Real_time_temperature="132";
   public static final String getEovData="133";
   public static final String DeleteEovData="134";


   public static final String getSleep_and_ActivityData="135";
   public static final String DeleteSleep_and_ActivityData="136";
   public static final String getSleepDebugging="137";
   public static final String DeleteSleepDebugging="138";

   public static final String getOSA="139";
   public static final String DeleteOSA="140";
   public static final String SetOSA="141";
   public static final String GetOSA="142";
