package com.jstyle.blesdkx3.other;


import android.util.Log;

import com.jstyle.blesdkx3.Util.BleSDK;
import com.jstyle.blesdkx3.Util.Temperature3NtcData;
import com.jstyle.blesdkx3.Util.TemperatureUtils;
import com.jstyle.blesdkx3.constant.BleConst;
import com.jstyle.blesdkx3.constant.DeviceConst;
import com.jstyle.blesdkx3.constant.DeviceKey;
import com.jstyle.blesdkx3.model.DeviceBean;
...
public class ResolveUtil {
    ...
    public static Map<String,Object> getDeviceInfo(byte[] value) {
        ...
        mapData.put(DeviceKey.Lauage, String.valueOf(getValue(value[14], 0)));
        return maps;
    }
    ...
    public static Map<String,Object> getDeviceBattery(byte[] value) {
        ...
        /* int Voltage_value = getValue(value[3 ], 0) + getValue(value[4 ], 1);*/
        mapData.put(DeviceKey.BatteryLevel, String.valueOf(battery));
      mapData.put(DeviceKey.Chargingstate, String.valueOf(Chargingstate));
        /* mapData.put(DeviceKey.Voltage_value, String.valueOf(Voltage_value));*/
        return maps;
    }
    ...
    public static Map<String,Object> getDeviceName(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.CMD_Get_Name);
        maps.put(DeviceKey.End,true);
        Map<String,String>mapData=new HashMap<>();
        maps.put(DeviceKey.Data, mapData);
        String name = "";
    ...
    public static Map<String,Object> getSleepData(byte[] value) {
        ...
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        boolean end=value[value.length - 1] == (byte) 0xff&& value[value.length - 2] ==DeviceConst.CMD_Get_SleepData;
    ...
    public static Map<String,Object> DeleteSpo2() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.DeleteSpo2);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    }
    public static Map<String,Object> DeleteEovData() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.DeleteEovData);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    ...
    public static Map<String,Object> DeleteSleep_and_ActivityData() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.DeleteSleep_and_ActivityData);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    ...
    public static Map<String,Object> DeletegetSleepDebugging() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.getSleepDebugging);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    }
    public static Map<String,Object> DeleteOSA() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.DeleteOSA);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    ...
    public static Map<String,Object> setOSA() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.SetOSA);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    ...
    public static Map<String,Object> DeletePPI() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.DeletePPI);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        return maps;
    ...
    public static Map<String,Object> getHrvTestData(byte[] value) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            hashMap.put(DeviceKey.breath, blood);
    ...
    protected static final SimpleDateFormat getClockDataformat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",Locale.US);
    public static Map<String,Object> getSpo2Data(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.ReadSpo2);
        maps.put(DeviceKey.End,false);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        int count = 30;
        ...
        for (int i = 0; i < size; i++) {
            ...
            System.arraycopy(value, count*i, values, 0, values.length);
            long yeardata=Long.parseLong("20" + bcd2String(values[3]));
            String date =yeardata + "-"
                    + bcd2String(values[4]) + "-" + bcd2String(values[5]) + " "
                    + bcd2String(values[6]) + ":" + bcd2String(values[7]) + ":" + bcd2String(values[8]);
          //  Log.e("ddfdfdg",date+"***"+byte2Hex(values));
            for (int v=0;v<(20);v++){
                int spo2=getValue(values[10+v],0);
                /*if(0!=spo2){*/
                Date afterDate = null;
                try {
                    afterDate = new Date(getClockDataformat.parse(date).getTime() + (v * 30000));
                } catch (Exception e) {}
                String DD=getClockDataformat.format(new Date(Objects.requireNonNull(afterDate).getTime()));
                // Log.e("ddfdfdg",DD+"***"+String.valueOf(spo2)+"\n");
                Map<String, String> hashMap = new HashMap<>();
                hashMap.put(DeviceKey.Date,DD);
                hashMap.put(DeviceKey.Sp02,String.valueOf(spo2));
    ...
    public static Map<String,Object> getppiData() {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.readPPI);
        maps.put(DeviceKey.End,false);
        List<Map<String, String>> mylist = new ArrayList<>();
        maps.put(DeviceKey.Data, mylist);
        maps.put(DeviceKey.End,true);;
        return maps;
    }
    public static Map<String,Object> getppiData(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.readPPI);
        maps.put(DeviceKey.End,false);
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.Data, list);
        List<Long> ppilist = new ArrayList<>();
        boolean ff = value[value.length - 1] == (byte) 0xff;
        if (2==value.length) {
            maps.put(DeviceKey.End,true);
            return maps;
        }
        ...
        byte[] values = new byte[value.length-11];
        System.arraycopy(value, 11, values, 0, values.length);
        for (int i=0;i<values.length/2;i++){
            long ppi=getValue(values[i*2],0)+getValue(values[(i*2)+1],1);
            if(0==getValue(values[i*2],0)){break;}
            ppilist.add(ppi);
        }
        long yeardata=Long.parseLong("20" + bcd2String(value[3]));
        String date =yeardata + "-"
                + bcd2String(value[4]) + "-" + bcd2String(value[5]) + " "
                + bcd2String(value[6]) + ":" + bcd2String(value[7]) + ":" + bcd2String(value[8]);
        Map<String, String> hashMap = new HashMap<>();
        hashMap.put(DeviceKey.Date,date);
        hashMap.put(DeviceKey.KPPIData, Arrays.toString(ppilist.toArray()));
        Calendar calendar=Calendar.getInstance(Locale.US);
        int year=calendar.get(Calendar.YEAR);
        if (year==yeardata){
            list.add(hashMap);
     ...
     * 氧气变化量
     */
    public static Map<String,Object> getEovData(byte[] value) {

        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.getEovData);
        maps.put(DeviceKey.End,false);
        ...
        boolean use181=181== length;
        if (191 == length||use181) {
            try {
                Map<String, String> hashMap = new HashMap<>();
                String date = "20" + bcd2String(value[3]) + "-" + bcd2String(value[4]) + "-" + bcd2String(value[5]) + " "
                        + bcd2String(value[6]) + ":" + bcd2String(value[7]) + ":" + bcd2String(value[8]);
                hashMap.put(DeviceKey.Date, date);
                int eovRiskCount = getValue(value[9], 0);
                int eovLength = getValue(value[10], 0)/*value.length-11*//*getValue(value[11], 0):getValue(value[10], 0)*/;
                hashMap.put(DeviceKey.KEovRiskCount, eovRiskCount + "");
                hashMap.put(DeviceKey.KEovLen, eovLength + "");
                StringBuilder stringBuffer = new StringBuilder();
                for (int j = 0; j < eovLength; j++) {
                    int values=getValue(value[11 + j], 0);
                    if (j == eovLength - 1) {
                ...
                hashMap.put(DeviceKey.KEovDataList, stringBuffer.toString());
                list.add(hashMap);
            }catch (Exception E){}
        }
        return maps;
    ...
    public static Map<String,Object> DeleteSleep_and_ActivityData(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.getSleep_and_ActivityData);
        maps.put(DeviceKey.End,false);
     ...
     String date = "20" + bcd2String(value[3]) + "-" + bcd2String(value[4]) + "-" + bcd2String(value[5]) + " "
                        + bcd2String(value[6]) + ":" + bcd2String(value[7]) + ":" + bcd2String(value[8]);
      hashMap.put(DeviceKey.Date, date);
      hashMap.put(DeviceKey.Data_length, String.valueOf(getValue(value[9], 0)));

       //前60
        byte[] values = new byte[value.length-70];
        System.arraycopy(value, 10, values, 0, values.length);
        List<Long> dd=new ArrayList<>();
        for (int i=0;i<values.length;i++){
           // 获取高半字节‌：
            long a= (values[i] >> 4) & 0x0F;
            long b= values[i] & 0x0F;
            dd.add(a);
            dd.add(b);
        }
        //后60
        byte[] values2 = new byte[values.length];
        System.arraycopy(value, 70, values2, 0, values2.length);
        List<Long> cc=new ArrayList<>();
        for (int i=0;i<values2.length;i++){
            cc.add((long) getValue(value[ i], 0));
        }
        hashMap.put(DeviceKey.Sleep_level, Arrays.toString(dd.toArray()));
        hashMap.put(DeviceKey.Activity_level, Arrays.toString(cc.toArray()));
        list.add(hashMap);
        return maps;
    }

    public static Map<String,Object> getSleepDebugging(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.getSleepDebugging);
        maps.put(DeviceKey.End,false);
        int length = value.length;
        ...
        for (int i = 0; i < size; i++) {
            ...
            Map<String, String> hashMap = new HashMap<>();
            hashMap.put(DeviceKey.Date, date);
            hashMap.put(DeviceKey.Sp02, String.valueOf(getValue(values[9], 0)));
            hashMap.put(DeviceKey.HeartRate, String.valueOf(getValue(values[10], 0)));
            hashMap.put(DeviceKey.Data_length, String.valueOf(getValue(values[11], 0)));
           List<Float>list1=new ArrayList<>();
            byte[] values1 = new byte[values.length-12];
            System.arraycopy(values, 12, values1, 0, values1.length);
            for (int d=0;d<values1.length/4;d++){
                byte[] values2 = new byte[4];
                System.arraycopy(values1, d*4, values2, 0, values2.length);
               // Log.e("ddfdfdg",byte2Hex(values2)+"\n");
                //list1.add( getFloat(values2,0));
                list1.add( bytesToFloat(values2));
            }
            hashMap.put(DeviceKey.ArrayListData, Arrays.toString(list1.toArray()));
            list.add(hashMap);
        }
    ...
    public static Map<String,Object> OSA(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.getOSA);
        maps.put(DeviceKey.End,false);
        int length = value.length;
        int count = 26;
        List<Map<String, String>> list = new ArrayList<>();
        ...
        for (int i = 0; i < size; i++) {
            long yeardata=Long.parseLong("20" + bcd2String(value[3 + i * count]));
            String date = yeardata+ "-" + bcd2String(value[4 + i * count]) +"-" + bcd2String(value[5 + i * count]) + " "
                    + bcd2String(value[6 + i * count]) + ":" + bcd2String(value[7 + i * count]) + ":" + bcd2String(value[8 + i * count]);
            Map<String, String> hashMap = new HashMap<>();
            hashMap.put(DeviceKey.Date, date);
            hashMap.put(DeviceKey.KOsaRick, String.valueOf(getValue(value[9 + i * count], 0)));
            list.add(hashMap);
        }
    ...
    public static Map<String,Object> getOSA(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.GetOSA);
        maps.put(DeviceKey.End,true);
        List<Map<String, String>> list = new ArrayList<>();
        ...
        Map<String, String> hashMap = new HashMap<>();
        hashMap.put(DeviceKey.OsaSwitch,  ResolveUtil.getValue(value[2], 0)==0? "0":"1");
        Calendar calendar=Calendar.getInstance();
        String year =String.valueOf(calendar.get(Calendar.YEAR));
        String firstTwoDigits = year.substring(0, 2);
        String MONTH=ResolveUtil.bcd2String(value[4]);
        String daY=ResolveUtil.bcd2String(value[5]);
        hashMap.put(DeviceKey.Date,  firstTwoDigits+ResolveUtil.bcd2String(value[3])+"-"+(MONTH.length()==1?"0"+MONTH:MONTH)+"-"+(daY.length()==1?"0"+daY:daY));
        list.add(hashMap);
        return maps;
    }
    ...
    public static float bytesToFloat(byte[] bytes) {
        ...
        buffer.order(ByteOrder.LITTLE_ENDIAN); // 或者使用ByteOrder.BIG_ENDIAN，取决于你的数据格式
        return buffer.getFloat();
    }

    public static Map<String,Object> getppiData(byte[] value,List<Long> listdata) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.readPPI);
        maps.put(DeviceKey.End,false);
        List<Map<String, String>> list = new ArrayList<>();
    ...
    public static Map<String, Object> getRealtime_ppg(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        maps.put(DeviceKey.DataType, BleConst.Realtime_ppg);
        maps.put(DeviceKey.End,false);
        Map<String, Object> hashMap = new HashMap<>();
        maps.put(DeviceKey.Data, hashMap);
        byte[] tempValue = new byte[value.length - 2];
        System.arraycopy(value, 2, tempValue, 0, tempValue.length);
        StringBuilder pp= new StringBuilder();
       List<Long>list1=new ArrayList<>();
        for (int j = 0; j < tempValue.length/8; j++) {
            byte[] valuea = new byte[4];
            for (int i = 0; i < 4; i++) {//0-3
                valuea[3 - i] = tempValue[4+(8*j)+i];
            }
            long ppg = getValue(valuea[0], 3) + getValue(valuea[1], 2)+ getValue(valuea[2], 1)+ getValue(valuea[3], 0) ;
          pp.append(ppg).append(j==(tempValue.length/8-1)?"": ",");

        }
        hashMap.put(DeviceKey.KPPGData, pp.toString());
        return maps;
    }
    ...
    public static Map<String,Object> getTempData(byte[] value) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String date = "20"+bcd2String(value[3 + i * count]) + "."
                    + bcd2String(value[4 + i * count]) + "." + bcd2String(value[5 + i * count]) + " "
                    + bcd2String(value[6 + i * count]) + ":" + bcd2String(value[7 + i * count]) + ":" + bcd2String(value[8 + i * count]);
            float  tempValue =( getValue(value[9 + i * count], 0)+getValue(value[10 + i * count], 1))*0.1f;
            float  tempValue2 = (getValue(value[11 + i * count], 0)+getValue(value[12 + i * count], 1))*0.1f;
            float  tempValue3 = (getValue(value[13 + i * count], 0)+getValue(value[14 + i * count], 1))*0.1f;
            hashMap.put(DeviceKey.Date, date);
            Temperature3NtcData temperature3NtcData= TemperatureUtils.vCalculatingBodyTemperature(new Temperature3NtcData(tempValue,tempValue2,tempValue3));
            hashMap.put(DeviceKey.temperature,numberFormat.format(temperature3NtcData.getChangtemp()));
            hashMap.put(DeviceKey.temperatureStatus, String.valueOf(temperature3NtcData.getTempStatus()));
   /*         hashMap.put(DeviceKey.temperature, numberFormat.format(tempValue*0.1f));
            hashMap.put(DeviceKey.temperature2, numberFormat.format(tempValue2*0.1f));
            hashMap.put(DeviceKey.temperature3, numberFormat.format(tempValue3*0.1f));*/
            list.add(hashMap);
        }
        return maps;
    }
    protected static final int mycout=6;
    public static Map<String,Object> getTempData3ntc(byte[] value) {
        Map<String,Object> maps=new HashMap<>();
        List<Map<String, String>> list = new ArrayList<>();
        maps.put(DeviceKey.DataType, BleConst.Temperature_history3ntc);
        maps.put(DeviceKey.End,false);
        maps.put(DeviceKey.Data, list);
        int count = 69;
        int length = value.length;
        ...
        for (int i = 0; i < size; i++) {
            ...
            byte[] bsa = new byte[count];
            System.arraycopy(value, i*count, bsa, 0, bsa.length);

           String date = "20"+bcd2String(bsa[3]) + "."
                    + bcd2String(bsa[4]) + "." + bcd2String(bsa[5]) + " "
                    + bcd2String(bsa[6]) + ":" + bcd2String(bsa[7 ]) + ":" + bcd2String(bsa[8 ]);

            Log.e("BleService","aa:"+byte2Hex(bsa)+"**"+date);

            byte[] bs = new byte[bsa.length-9];
            System.arraycopy(bsa, 9, bs, 0, bs.length);
           // Log.e("BleService","bb:"+byte2Hex(bs));

            for (int bba=0;bba<bs.length/mycout;bba++){
                byte[] bsaa = new byte[mycout];
                System.arraycopy(bs, bba*mycout, bsaa, 0, bsaa.length);
                float  tempValue = (getValue(bsaa[0 ], 0)+getValue(bsaa[1 ], 1))*0.1f;
                float  tempValue2 = (getValue(bsaa[2 ], 0)+getValue(bsaa[3 ], 1))*0.1f;
                float  tempValue3 = (getValue(bsaa[4], 0)+getValue(bsaa[5 ], 1))*0.1f;
               /* List <String> list1=new ArrayList<>();
                list1.add(numberFormat.format(tempValue*0.1f));
                list1.add(numberFormat.format(tempValue2*0.1f));
                list1.add(numberFormat.format(tempValue3*0.1f));*/
                Map<String, String> hashMap = new HashMap<>();
                Temperature3NtcData temperature3NtcData= TemperatureUtils.vCalculatingBodyTemperature(new Temperature3NtcData(tempValue,tempValue2,tempValue3));
                hashMap.put(DeviceKey.temperature,numberFormat.format(temperature3NtcData.getChangtemp()));
                hashMap.put(DeviceKey.temperatureStatus, String.valueOf(temperature3NtcData.getTempStatus()));
                ...
                Date afterDate = null;
                try {
                    afterDate = new Date(Objects.requireNonNull(format.parse(date)).getTime() + (bba * 60000));
                } catch (Exception e) {
                }
                hashMap.put(DeviceKey.Date, /*0==bba?date:*/format.format(new Date(Objects.requireNonNull(afterDate).getTime())));
                //Log.e("BleService","cc:"+date+"***"+format.format(new Date(Objects.requireNonNull(afterDate).getTime())));
                list.add(hashMap);

            }

      /*      int  tempValue = getValue(value[9 + i * count], 0)+getValue(value[10 + i * count], 1);
            int  tempValue2 = getValue(value[11 + i * count], 0)+getValue(value[12 + i * count], 1);
            int  tempValue3 = getValue(value[13 + i * count], 0)+getValue(value[14 + i * count], 1);*/
...
/*    public static void Getecgdata(byte[] value,Databack databack) {
    ...
    protected static String getDoublePPGData(byte[] value) {
        ...
        for (int i = 0; i < length; i++) {
            int ecgValue = ResolveUtil.getValue(value[2*i], 1) + ResolveUtil.getValue(value[2*i+1], 0);
            /*    if (ecgValue >= 32768) ecgValue = ecgValue - 65536;*/
            stringBuffer.append(ecgValue).append(",");
        }
        return stringBuffer.toString();
    ...
    public static Map<String,Object> getActivityExerciseData(byte[] value) {
        ...
        map.put(DeviceKey.ActiveMinutes, String.valueOf(time));
        return maps;
    }
     ...
     *
     */
    public static  Map<String, Object> GetWomenHealth(byte[] value) {
        Map<String, Object> hashMap = new HashMap<>();
        hashMap.put(DeviceKey.DataType, BleConst.GetWomenHealth);
        hashMap.put(DeviceKey.End,true);
        Map<String,String>mapData=new HashMap<>();
        mapData.put(DeviceKey.Month, bcd2String(value[1]));
        mapData.put(DeviceKey.Day, bcd2String(value[2]));
        mapData.put(DeviceKey.MenstrualPeriod_Lenth, bcd2String(value[3]));
        mapData.put(DeviceKey.MenstrualPeriod_Period, bcd2String(value[4]));
        hashMap.put(DeviceKey.Data, mapData);
        return hashMap;
    }

    public static  Map<String, Object> Getpeisu(int nungb) {
        Map<String, Object> hashMap = new HashMap<>();
        hashMap.put(DeviceKey.DataType, BleConst.Getpeisu);
        hashMap.put(DeviceKey.End,true);
        Map<String,String>mapData=new HashMap<>();
        mapData.put(DeviceKey.Day, nungb+"");
        hashMap.put(DeviceKey.Data, mapData);
        return hashMap;
    }

    public static  Map<String, Object> GetpeisuER() {
        Map<String, Object> hashMap = new HashMap<>();
        hashMap.put(DeviceKey.DataType, BleConst.GetpeisuER);
        hashMap.put(DeviceKey.End,true);
        Map<String,String>mapData=new HashMap<>();
        hashMap.put(DeviceKey.Data, mapData);
        return hashMap;
     ...
     *
     */
    public static  Map<String, Object> GetPregnancyCycle(byte[] value) {
        Map<String, Object> hashMap = new HashMap<>();
        hashMap.put(DeviceKey.DataType, BleConst.GetPregnancyCycle);
        hashMap.put(DeviceKey.End,true);
        Map<String,String>mapData=new HashMap<>();
        mapData.put(DeviceKey.Year, bcd2String(value[3]));
        mapData.put(DeviceKey.Month, bcd2String(value[4]));
        mapData.put(DeviceKey.Day, bcd2String(value[5]));
        hashMap.put(DeviceKey.Data, mapData);
        return hashMap;
    }
